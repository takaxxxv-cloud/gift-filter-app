...
with st.sidebar:
    ...
    # 💡 変更：投資家一覧も複数アップロード（個人・法人など）に対応！
    uploaded_file_members = st.file_uploader("1. 投資家一覧CSV（★複数選択OK：個人・法人など）", type="csv", accept_multiple_files=True)
